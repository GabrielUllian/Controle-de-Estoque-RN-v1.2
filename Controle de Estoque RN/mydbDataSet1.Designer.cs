...
namespace Controle_de_Estoque_RN {
    ...
    public partial class mydbDataSet1 : global::System.Data.DataSet {
        ...
        public partial class produtosDataTable : global::System.Data.TypedTableBase<produtosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public produtosRow AddprodutosRow(string descricao, string preco, int quantidade, int unidade, int idFornecedor) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public produtosRow FindByidProdutos(int idProdutos) {
        ...
        public partial class produtosRow : global::System.Data.DataRow {
            ...
            public int idProdutos {
                get {
                    return ((int)(this[this.tableprodutos.idProdutosColumn]));
                }
                set {
...
namespace Controle_de_Estoque_RN.mydbDataSet1TableAdapters {
    ...
    public partial class produtosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `produtos` WHERE ((`idProdutos` = @p1) AND (`descricao` = @p2) AND ((" +
                "@p3 = 1 AND `preco` IS NULL) OR (`preco` = @p4)) AND (`quantidade` = @p5) AND (`" +
                "unidade` = @p6) AND (`idFornecedor` = @p7))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `produtos` (`descricao`, `preco`, `quantidade`, `unidade`, `idFornece" +
                "dor`) VALUES (@p1, @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `produtos` SET `descricao` = @p1, `preco` = @p2, `quantidade` = @p3, `unidade` = @p4, `idFornecedor` = @p5 WHERE ((`idProdutos` = @p6) AND (`descricao` = @p7) AND ((@p8 = 1 AND `preco` IS NULL) OR (`preco` = @p9)) AND (`quantidade` = @p10) AND (`unidade` = @p11) AND (`idFornecedor` = @p12))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `idProdutos`, `descricao`, `preco`, `quantidade`, `unidade`, `idFornecedor" +
                "` FROM `produtos`";
        ...
        public virtual int Fill(mydbDataSet1.produtosDataTable dataTable) {
        ...
        public virtual mydbDataSet1.produtosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydbDataSet1.produtosDataTable dataTable = new mydbDataSet1.produtosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydbDataSet1.produtosDataTable dataTable) {
        ...
        public virtual int Update(string p1, string p2, int p3, int p4, int p5, int p6, string p7, string p9, int p10, int p11, int p12) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
